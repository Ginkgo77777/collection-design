...
这里是[寒假轮学习](https://github.com/west2-online/learn-design/blob/main/steps/winter/README.md)的作业提交目录。
...
> [!WARNING]
> 提交范例全部由 AI 生成，如有侵权请及时联系仓库管理者。
> 范例仅用于说明文件结构和记录方式，请勿复制其中的内容、数据或结论。

```txt
winter
|___ README.md
|___ task1
|    |___ README.md          // 本轮任务的提交说明
|    |___ example            // 提交范例(仅作格式参考)
...
|    |___ <你的 GitHub ID>
|___ task3
     |___ README.md          // 面试展示说明, 无需创建个人提交目录
```

- `task1` 与 `task2`：在对应任务目录下创建以你的 **GitHub ID** 命名的文件夹，提交本仓库要求的说明、记录、源文件或稳定链接。
- `term1/task5` 的博客、作品集与 Three.js 工程等完整源码继续在个人仓库维护，在 README 中提供可访问链接；不要为提交复制一份失去后续维护的项目。
- 请先阅读任务目录下的 `README.md` 与 `example` 范例，再根据真实过程调整结构。建议结构不是固定模板，信息完整、链接可用且便于审核即可。
